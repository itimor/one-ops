# Generated by Django 3.0.3 on 2020-07-27 04:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[(0, 'mail'), (1, 'telegram')], default=0, max_length=10, verbose_name='通知类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('memo', models.TextField(blank=True, verbose_name='备注')),
                ('type', models.CharField(choices=[(0, 'mail'), (1, 'telegram')], default=1, max_length=10, verbose_name='通知类型')),
                ('name', models.CharField(max_length=112, unique=True, verbose_name='名称')),
